...
public class CoinApiController {
	...
	// 2023-03-04 -> 여기까지 완료
	@GetMapping("/coins")
	public ResponseEntity<?> list(@AuthenticationPrincipal PrincipalDetails principalDetails) throws Exception {
		log.info("충전 list API");
		
		Member loginUser = principalDetails.getMember();	
		List<ChargeCoin> result = coinService.findByUserNo(loginUser.getUserNo());
