...
public class CodeGroupService {
	...
	private final ICodeGroupMapper codeGroupMapper;
	
	public int register(CodeGroup codeGroup) {
		
		Optional<CodeGroup> codeGroupOp = codeGroupMapper.findByGroupCode(codeGroup.getGroupCode());
		
		if(!codeGroupOp.isPresent()) {
			int result = codeGroupMapper.save(codeGroup);
	...
	public List<CodeGroup> findAll(){
		...
		try {
			result = codeGroupMapper.findAll();
	...
	public CodeGroup findByGroupCode(String groupCode) {
		...
		Optional<CodeGroup> codeGroupOp = codeGroupMapper.findByGroupCode(groupCode);
