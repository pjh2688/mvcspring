...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -2037473009L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCartItem cartItem = new QCartItem("cartItem");

    public final com.shop.entity.cart.QCart cart;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.cart = inits.isInitialized("cart") ? new com.shop.entity.cart.QCart(forProperty("cart"), inits.get("cart")) : null;
